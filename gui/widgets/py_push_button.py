...
#
# This project has MIT license and is intended to provide a Graphical
# use interface to have insights from fit images relatives to Coronal
# Mass Ejections (CME)
#
