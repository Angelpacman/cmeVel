...
################################################################################
## Form generated from reading UI file 'pagesFABxxY.ui'
##
...
class Ui_StackedWidget(object):
    ...
    def retranslateUi(self, StackedWidget):
        ...
        self.label.setText(QCoreApplication.translate("StackedWidget", u"Inicio", None))
        self.label_2.setText(QCoreApplication.translate("StackedWidget", u"Datos", None))
        self.label_3.setText(QCoreApplication.translate("StackedWidget", u"Ayuda", None))
    # retranslateUi
