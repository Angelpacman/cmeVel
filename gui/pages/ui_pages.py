...
class Ui_application_pages(object):
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label.setText(QCoreApplication.translate("application_pages", u"Inicio", None))
        self.label_2.setText(QCoreApplication.translate("application_pages", u"Datos", None))
        self.label_3.setText(QCoreApplication.translate("application_pages", u"Ayuda", None))
    # retranslateUi
